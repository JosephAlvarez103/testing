...
def ayuda(request):
    ...
    subject_email_map = {
        ...
        'Estado del pedido': 'bodega@papelerialosandes.com',
        'Sugerencias, reclamos o devoluciones': 'asistente.administrativo@papelerialosandes.com',
        'Facturación y pagos': 'asistente.administrativo@papelerialosandes.com',
